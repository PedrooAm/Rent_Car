...
A aplicação utiliza um **menu interativo**, onde o utilizador navega escolhendo opções numeradas (1 a 4) para aceder a diferentes funcionalidades.

**Estado Atual:** O projeto encontra-se em fase inicial de desenvolvimento, servindo como estrutura base para um sistema completo futuro com interface gráfica e base de dados relacional.
